...
const JOBS = {
  ...
  // character-implants + character-clones per character in one invocation. The
  // four individual entries above stay for manual/backfill runs, but the cron
  // and the /character/refresh UI dispatch this one instead.
  'character-status': {
    characterIds: true,
