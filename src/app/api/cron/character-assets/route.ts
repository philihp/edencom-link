...
// Vercel Cron replacement for the old `character-assets.yml` GitHub Action. Fans out
...
export async function GET(request: NextRequest) {
  ...
  const dispatched = await fanOutPerCharacterCronJob('character-assets', SCOPE)
