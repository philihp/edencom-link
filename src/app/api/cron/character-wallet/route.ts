...
// Vercel Cron replacement for the old `character-wallet.yml` GitHub Action. Fans out
...
export async function GET(request: NextRequest) {
  ...
  const dispatched = await fanOutPerCharacterCronJob('character-wallet', SCOPE)
