...
// Replaces the build-time generated JSON: resolves known-space system names and
// searches by name without an ESI call. By-id lookups are cached per server
// process for 6h (misses never cached — see src/sdeCache.ts). Mirrors
// src/sdeTypes.ts.
