...
| `character-status` | `/characters/{id}/wallet/` + `/location/` + `/implants/` + `/clones/` + `/ship/` + `/skills/` | `character_wallet`, `character_location`, `character_implant`, `character_clone_over_time`, `character_clone_state`, `character_ship`, `character_skill` | every 6h `:14` |
...
| `character_skill` | Live current trained-skill levels (drives the character-list industry job-slot bubbles) | `character_id`+`skill_id` (PK), `active_skill_level`, `trained_skill_level`, `recorded_at` |
